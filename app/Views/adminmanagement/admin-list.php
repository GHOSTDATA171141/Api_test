						...
						<tbody>
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										<a class="btn btn-warning" href="<?php echo site_url(); ?>adminmanagement/editadmin/<?= $item['admin_id']; ?>" role="button"><i class="fas fa-edit"></i></a>
										<a class="btn btn-danger" value="<?= $item['firstname']; ?>" onclick="confirmDelete(event)" href="<?= base_url(); ?>/adminmanagement/deleteadmin/<?= $item['admin_id']; ?>" role="button"><i class="fas fa-trash"></i></a>
									</td>
								</tr>
							<?php endforeach; ?>
