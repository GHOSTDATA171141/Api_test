                    ...
                    <?php foreach ($data as $item) : ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="ชื่อจริง" value="<?= $item['cou_name_th']; ?> " required >
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">ชื่อภาษาอังกฤษ</label>
                                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="นามสกุล" value="<?= $item['cou_name_en']; ?>" required >
                            </div>
                        </div>
                            <div class="form-group">
                                <label for="inputAddress">เลขกำกับถาษี 13 หลัก</label>
                                <input type="text" class="form-control" id="idcard" name="idcard" placeholder="" value="<?= $item['cou_taxpayer_number']; ?>" >
                            </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="category" name="category" placeholder="ประเภทของบริษัท" value="<?= $item['cou_category']; ?>">
                            </div>
                            <div class="form-group col-md-6">
