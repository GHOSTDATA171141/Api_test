								...
								<?php foreach ($data as $item) : ?>
									<tr>
										...
										<td>
											...
											<a class="btn btn-info" href="<?php echo site_url(); ?>adminmanagement/editmember/<?= $item['member_id']; ?>" role="button"><i class="fas fa-edit"></i></a>
											<a class="btn btn-warning" value="<?= $item['fullname']; ?>" onclick="confirmBan(event)" href="<?php echo site_url(); ?>/adminmanagement/banmember/<?= $item['member_id']; ?>" role="button"><i class="fas fa-ban"></i></a>
