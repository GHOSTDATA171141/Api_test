							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										<a class="btn btn-warning" value="<?= $item['fullname']; ?>" onclick="confirmApprove(event)" href="<?= base_url(); ?>/adminmanagement/approvemember/<?= $item['member_id']; ?>" role="button"><i class="fas fa-check"></i></a>
										<a class="btn btn-danger" value="<?= $item['fullname']; ?>" onclick="confirmDelete(event)" href="<?= base_url(); ?>/adminmanagement/banmember/<?= $item['member_id']; ?>" role="button"><i class="fas fa-times"></i></a>
