						...
						<tbody>
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td><?= $item['cou_approved_at']; ?></td>
									<td>
										<p>อนุมัติแล้ว <a class="btn btn-success chru"  style="color :#FFF"   data-id="<?= $item['cou_id']; ?>" data-toggle="modal" data-target="#requestInfo"  aria-label="Close" role="button"><i class="fas fa-eye"></i></a></p>
