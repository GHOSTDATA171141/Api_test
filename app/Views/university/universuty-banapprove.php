							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										href="<?php echo site_url(); ?>/adminmanagement/unbanuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-sign-in-alt"></i></a>
										<a class="btn btn-danger" value="<?= $item['cou_name_th']; ?>" onclick="confirmDelete(event)"
										 href="<?= base_url(); ?>/adminmanagement/deleteuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-trash"></i></a>
